                    ...
                    <div class="p-6">
                        ...
                        <div class="mb-6">
                            ...
                            <input type="text" id="title" name="title"
                                value="{{ old('title', $jobVacancy->title) }}" placeholder="e.g. Software Engineer"
                        ...
                        <div class="mb-6">
                            ...
                            <input type="number" step="0.01" min="0" id="salary" name="salary"
                                value="{{ old('salary', $jobVacancy->salary) }}" placeholder="e.g. 60000"
                                class="w-full rounded-lg border-gray-300 shadow-sm
                                       focus:border-indigo-500 focus:ring-indigo-500">
                        ...
                        <div>
                            ...
                            <select name="type" id="type"
                                ...
                                <option value="Full-Time"
                                    {{ old('type', $jobVacancy->type) == 'Full-Time' ? 'selected' : '' }}>Full-Time
                                </option>
                                <option value="Contract"
                                    {{ old('type', $jobVacancy->type) == 'Contract' ? 'selected' : '' }}>Contract
                                </option>
                                <option value="Remote"
                    ...
                    <select name="jobCategoryId" id="jobCategoryId"
                        ...
                        @foreach ($categories as $category)
                            <option value="{{ $category->id }}"
                                {{ old('jobCategoryId', $jobVacancy->job_category_id) == $category->id ? 'selected' : '' }}>
                                {{ $category->name }}
                            </option>
                        @endforeach
